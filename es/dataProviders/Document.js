  ...
  _createClass(DocWrapper, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          parseDataBeforeChange = _props.parseDataBeforeChange,
          resProps = _objectWithoutProperties(_props, ['isOpen', 'customTitle', 'onClose', 'saveOnBlur', 'targetName', 'schemaName', 'fields', 'objectId', 'viewComponent', 'extraData', 'fieldsOptions', 'messages', 'dataFromCollection', 'modalId', 'minimizedDocumentBeforeMe', 'toggleMinimized', 'toggleFullScreen', 'onPostFinished', 'onDeleteFinished', 'onPutFinished', 'isMinimized', 'fullScreen', 'onRefresh', 'collectionData', 'parseDataBeforeChange']);
