  ...
  _createClass(Collection, [{
    ...
    value: function render() {
      var _props5 = this.props,
          ...
          resProps = _objectWithoutProperties(_props5, ['targetName', 'schemaName', 'query', 'leaveClean', 'viewComponent', 'onClose', 'extraData', 'onCreateNewDoc', 'onEditDoc', 'fields', 'keys', 'include', 'functionName', 'dataHandler']);
